...
class Location {
    ...
    public function crear($name, $city, $state, $photo, $availableUnits, $wifi, $laundry) {
    ...
    public function actualizar($id, $name, $city, $state, $photo, $availableUnits, $wifi, $laundry) {
